...
>
  ...
  <body>
    ...
    <div style="background-image: url('assets/img/background.jpg'); background-size:100% 100%;" class="container-xxl">
    ...
    if (isset($_POST['login'])) {
      ...
      $user = $koneksi->query("SELECT * FROM tb_user WHERE username='$username' AND password='$password'");
