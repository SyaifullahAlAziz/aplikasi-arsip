...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div style="background-color:#696cff; height:50px;" class="card-header">
            <h4 style="color:white; position:absolute; top:12px;">Daftar Data</h4>
        </div>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="data_tampil/cetak.php?id_berkas=<?= $data['id_berkas'] ?>" class="btn btn-sm btn-info"><i class="bx bx-printer"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                </tbody>
